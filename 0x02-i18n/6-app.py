#!/usr/bin/env python3
"""
Changes get_locale function to use a user’s
...
def before_request() -> None:
    """
    This function performs some routines
    before each request's resolution.
    """
...
@app.route('/')
def index() -> str:
    """routes index(default) that returns homepage"""
